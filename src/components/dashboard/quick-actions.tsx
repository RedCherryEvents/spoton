...
const ACTIONS: Action[] = [
  ...
  { labelKey: 'newDeal', href: '/pipelines', icon: Briefcase, tint: 'text-muted-foreground' },
  { labelKey: 'newBroadcast', href: '/broadcasts/new', icon: Radio, tint: 'text-muted-foreground' },
